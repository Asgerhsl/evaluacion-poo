...
este codigo red¿sualve un sistema de adopcion para una veterinaria, mas especificamente el centro de adopcion de esta misma. 
...
en el codigo como tal se dejaron registrados los cometarios, donde se puede ver el uso de clases,objetos, herencia, en encapculamineto, polimorfismo y para realiazr este codigo nos estuvimos guiando con guias anteriormente realizadas en clase e IA (Gemini) ji 
